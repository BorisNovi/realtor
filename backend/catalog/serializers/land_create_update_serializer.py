# catalog/serializers/Land_create_update_serializer.py
from rest_framework import serializers
from catalog.catalog_models import Land
...
# Сериализатор для создания/обновления объектов Land
class LandCreateUpdateSerializer(BaseCreateUpdateSerializer):
